...
if(isset($_REQUEST['debugTest']) && ($_REQUEST['debugTest']) == 1){
...
//firebase
define("FCM_KEY","AAAAkacTpjk:APA91bERLUoJG-lIKT0u5IOa4yNpRf3CHzMWAspXJp1JvkrC_JQlBr9atS4UUbPhcy0sHRE8LV38E6zlbQRT8LLptkMpHsKACHIIqTjNmEFUc8954A0g4G3GnMfKB1UhsyeYK_BbM6vU");
...
define("CHATTING_IMAGE_PATH",PATH_URL.'resources/image/chat/');
...
// include_once(__DIR__."/my_function.php");
...
define("UPLOAD_CHATTING_IMAGE_PATH", DIR_PATH.'/resources/image/chat/');
